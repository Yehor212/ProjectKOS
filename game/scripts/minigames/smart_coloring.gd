...
func _start_round() -> void:
	...
	_brush_width = _scale_adaptive(base_brush, base_brush * 0.65, _round, _total_rounds)
	_min_strokes_round = _scale_adaptive_i(MIN_STROKES_DONE, MIN_STROKES_DONE + 4, _round, _total_rounds)
...
func _process_preschool_zone() -> void:
	...
	var threshold: int = _scale_adaptive_i(2, 4, _round, _total_rounds)
