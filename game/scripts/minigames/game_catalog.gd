...
const GAMES: Array[Dictionary] = [
	...
	{
		"id": "story_cards",
		"name_key": "GAME_STORY_CARDS",
		"desc_key": "DESC_STORY_CARDS",
		"skill_key": "SKILL_STORY_CARDS",
		"icon": "book",
		"color": Color("e17055"),
		"scene_path": "res://scenes/main/story_cards.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "sound_match",
		"name_key": "GAME_SOUND_MATCH",
		"desc_key": "DESC_SOUND_MATCH",
		"skill_key": "SKILL_SOUND_MATCH",
		"icon": "microphone",
		"color": Color("f9a825"),
		"scene_path": "res://scenes/main/sound_match.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "phonics_pop",
		"name_key": "GAME_PHONICS_POP",
		"desc_key": "DESC_PHONICS_POP",
		"skill_key": "SKILL_PHONICS_POP",
		"icon": "bubble",
		"color": Color("66bb6a"),
		"scene_path": "res://scenes/main/phonics_pop.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "mirror_draw",
		"name_key": "GAME_MIRROR_DRAW",
		"desc_key": "DESC_MIRROR_DRAW",
		"skill_key": "SKILL_MIRROR_DRAW",
		"icon": "pencil",
		"color": Color("b388ff"),
		"scene_path": "res://scenes/main/mirror_draw.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
]
