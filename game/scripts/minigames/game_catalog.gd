...
const GAMES: Array[Dictionary] = [
	...
	{
		"id": "rhyme_match",
		"name_key": "GAME_RHYME_MATCH",
		"desc_key": "DESC_RHYME_MATCH",
		"skill_key": "SKILL_RHYME_MATCH",
		"icon": "music_note",
		"color": Color("ab47bc"),
		"scene_path": "res://scenes/main/rhyme_match.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "freeze_dance",
		"name_key": "GAME_FREEZE_DANCE",
		"desc_key": "DESC_FREEZE_DANCE",
		"skill_key": "SKILL_FREEZE_DANCE",
		"icon": "snowflake",
		"color": Color("42a5f5"),
		"scene_path": "res://scenes/main/freeze_dance.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
	...
	{
		"id": "letter_tracing",
		"name_key": "GAME_LETTER_TRACING",
		"desc_key": "DESC_LETTER_TRACING",
		"skill_key": "SKILL_LETTER_TRACING",
		"icon": "pencil",
		"color": Color("ff9f43"),
		"scene_path": "res://scenes/main/letter_tracing.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "plant_grow",
		"name_key": "GAME_PLANT_GROW",
		"desc_key": "DESC_PLANT_GROW",
		"skill_key": "SKILL_PLANT_GROW",
		"icon": "pine_tree",
		"color": Color("4caf50"),
		"scene_path": "res://scenes/main/plant_grow.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "measure_up",
		"name_key": "GAME_MEASURE_UP",
		"desc_key": "DESC_MEASURE_UP",
		"skill_key": "SKILL_MEASURE_UP",
		"icon": "ruler",
		"color": Color("26de81"),
		"scene_path": "res://scenes/main/measure_up.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "peek_a_boo",
		"name_key": "GAME_PEEK_A_BOO",
		"desc_key": "DESC_PEEK_A_BOO",
		"skill_key": "SKILL_PEEK_A_BOO",
		"icon": "magnifier",
		"color": Color("66bb6a"),
		"scene_path": "res://scenes/main/peek_a_boo.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "animal_pop",
		"name_key": "GAME_ANIMAL_POP",
		"desc_key": "DESC_ANIMAL_POP",
		"skill_key": "SKILL_ANIMAL_POP",
		"icon": "hand_tap",
		"color": Color("ef6c00"),
		"scene_path": "res://scenes/main/animal_pop.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "whats_missing",
		"name_key": "GAME_WHATS_MISSING",
		"desc_key": "DESC_WHATS_MISSING",
		"skill_key": "SKILL_WHATS_MISSING",
		"icon": "magnifier",
		"color": Color("7e57c2"),
		"scene_path": "res://scenes/main/whats_missing.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
	{
		"id": "premium_demo",
		"name_key": "GAME_PREMIUM_DEMO",
		"desc_key": "DESC_PREMIUM_DEMO",
		"skill_key": "SKILL_PREMIUM_DEMO",
		"icon": "star",
		"color": Color("ff6b6b"),
		"scene_path": "res://scenes/main/premium_demo.tscn",
		"unlocked": true,
		"age": AgeCategory.ALL,
	},
]
